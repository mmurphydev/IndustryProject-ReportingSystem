$(document).ready(
    function(){
     ...
     /*
     Function which makes get request to /getTodaysReportsIT.
    ...
    function getTodaysReports() {			
       ...
       // setTimeout(getTodaysReportsIT, 1000); // recursively calls getTodaysReports (comments are refreshed every 10 seconds)
    }
        ...
        */
        ...
        if(targetArray[0] == "delete"){
            ...
            success: function(result) {
                getTodaysReportsIT(); //reloads Reports
                    }
            });
        }
    });
